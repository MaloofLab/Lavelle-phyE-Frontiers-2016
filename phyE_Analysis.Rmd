...
epi.int12.results$genotype <- factor(epi.int12.results$genotype,
                                     levels=c("MM","A","B1","B2","E7","B12","1E7","2E7","TR7","QD7"),
                                     labels=unlist(strsplit("MoneyMaker, phyA, phyB1, phyB2, phyE, phyB1/phyB2, phyB1/phyE, phyB2/phyE, phyB1/phyB2/phyE, phyA/phyB1/phyB2/phyE",split=", ")))
...
pl <- pl + ylab("length (mm)")
 pl + geom_text(aes(label=p.value.txt,y=epi.int12+18),position=position_dodge(width=0.9))

...
author: "Julin Maloof"
date: "August 10, 2015; updated July 11-18, 2016"
...
ggsave("phyE_epicotyl.pdf",height=5,width=7.5)
```
...
summary(glht(lmer.epi4, linfct=contr),test=adjusted("holm"))
...
comparisons <- c("genotypeTR7:treatmentshade - genotypeB12:treatmentshade = 0",
                 "genotypeTR7:treatmentshade - genotypeB1E7:treatmentshade = 0",
                 "genotypeTR7:treatmentshade - genotypeB2E7:treatmentshade = 0")

glht2 <- glht(lmer.epi.int12_2,linfct=comparisons)

summary(glht2,test=adjusted("Westfall"))
